...
[![GitHub release downloads](https://img.shields.io/github/downloads/slavelee777/showmethemoney/total?label=downloads&color=c1f76c&labelColor=192219)](https://github.com/slavelee777/showmethemoney/releases "All release downloads / 전체 릴리스 다운로드 횟수")
...
불편한 점이나 버그는 [Issues](https://github.com/slavelee777/showmethemoney/issues)에 남겨주세요.
...
To build from source, use the commands above. The Mac app uses Swift/AppKit; Windows uses C#/WinForms. Found a bug? [Open an issue](https://github.com/slavelee777/showmethemoney/issues).
